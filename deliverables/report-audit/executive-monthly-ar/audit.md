# Report Deliverable Audit — executive-monthly-ar
...
**File:** `/Users/mohammedalharbimacbook/Developer/CampaignsHub-UI/deliverables/report-audit/executive-monthly-ar/source.pdf`

| Field | Value |
|---|---|
| Filename | `executive-monthly-ar/source.pdf` |
| Audience | executive |
...
| Chrome | ✅ tested — Chromium/PDFium loads all 6 pages, renders Arabic correctly |
