# Report Deliverable Audit — internal-performance-ar
...
**File:** `/Users/mohammedalharbimacbook/Developer/CampaignsHub-UI/deliverables/report-audit/internal-performance-ar/source.pdf`

| Field | Value |
|---|---|
| Filename | `internal-performance-ar/source.pdf` |
| Audience | internal |
...
| Snapshot Checksum / Provenance | present (internal provenance retained by design) |
