# Report Deliverable Audit — client-platform-comparison-ar
...
**File:** `/Users/mohammedalharbimacbook/Developer/CampaignsHub-UI/deliverables/report-audit/client-platform-comparison-ar/source.pdf`

| Field | Value |
|---|---|
| Filename | `client-platform-comparison-ar/source.pdf` |
| Audience | client |
