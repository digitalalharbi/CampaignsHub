...
final class CredentialMail extends Mailable
{
    ...
    public function content(): Content
    {
        ...
        $body['t'] = $shell['t'] + ($ar
            ? [
                'never_share' => 'لا تشارك هذا الرمز مع أي شخص. لن يطلبه منك فريق كامبينز هَب في أي مكالمة أو رسالة.',
    ...
    private function words(): array
    {
        ...
        return match ($this->purpose) {
            ...
            self::MEMBER_SETUP => $ar ? [
                ...
                'title' => 'حسابك في كامبينز هَب جاهز',
                'intro' => $this->workspace !== ''
                    ? "أُضيف حسابك إلى مساحة عمل {$this->workspace} على كامبينز هَب. اختر كلمة المرور لتتمكن من تسجيل الدخول."
                    : 'أُضيف حسابك إلى كامبينز هَب. اختر كلمة المرور لتتمكن من تسجيل الدخول.',
