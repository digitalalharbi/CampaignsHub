...
final class LiveReportService
{
    ...
    public function platform(ReportShare $share, string $provider, array $requested): ?array
    {
        ...
        $payload = app(PlatformDrilldownBuilder::class)->build(
            provider: $provider,
            whole: $whole,
            ...
            from: $from,
            to: $to,
            hideSpend: (bool) $share->hide_spend,
            hideRevenue: (bool) $share->hide_revenue,
            withObjectives: (bool) ($share->visibleSections()['objective_breakdown'] ?? true),
        ) + [
            'ads' => $content['ads'] ?? [],
