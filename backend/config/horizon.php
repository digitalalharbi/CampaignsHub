...
return [
    ...
    */
    ...
    /*
     * PROD-001 — the supervisor watches BOTH queues, and its settings match the runbook's worker.
     *
     * Horizon's published default watches `default` alone. This application dispatches report
     * generation onto `reports` (`ReportExportJob`, the scheduled-report dispatcher), so an
     * installation that replaced `queue:work` with Horizon — which is the entire point of installing
     * it — would have left every report sitting at «قيد المعالجة» forever, with a dashboard beside it
