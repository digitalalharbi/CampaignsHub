...
**Still to come in §15:** the interactive Creative Details PAGE (§15.6 — the API is live and the viewer is built; the drill-down currently ends at the viewer), the Creative Groups UI (§15.13 — the endpoints exist, no UI), and the E2E half of the acceptance tests. §15.10, §15.11 and §15.12 are done — see CREATIVE-014 … CREATIVE-033.
