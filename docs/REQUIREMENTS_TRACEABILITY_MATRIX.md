...
| HOME-011 | A HOME | Compact balanced marketing hero preview (marketing variant = 4 KPIs + platforms+donut side-by-side + 3 top campaigns; no long dashboard tail) | n/a | ✓ | 7 chromium homepage E2E + 15 vitest | **VERIFIED** | 4e0e2d0 | (minor) AR-only preview labels on EN |
