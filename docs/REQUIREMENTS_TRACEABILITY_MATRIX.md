...
| AUTH-002 | B AUTH | Login marketing panel adapts to portal (?portal / /client redirect): paid/influencer/client, same auth engine | n/a | ✓ | 13 auth vitest (3 new) | **VERIFIED** | 6d7f26b | — |
