...
| FILE-001 | P | Files module (Drive folder links per scope + browse/attach) + summary + search | Drive domain | ✓ (summary by scope Total/Clients/Projects/Campaigns, search, full-width, states; link/browse/attach/unlink; nav «الملفات») | tsc+build; browser | **PARTIAL** | 0791c84 | pending: unified files across clients/projects/campaigns/requests/reports/invoices + preview/perms; mobile/dark verify |
