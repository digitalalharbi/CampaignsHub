...
| HOME-013 | A HOME | Differentiated public experiences per portal (?portal=paid/influencer/client) — distinct hero copy + tailored preview, same design system | n/a | ✓ | 18 marketing vitest (3 new) + browser | **VERIFIED** | 820f3ee | preview cards are lightweight lists (not live data) by design — marketing only |
