...
| PAY-002 | PLATFORM | Subscription lifecycle: auto-renewal, cancellation, upgrade/downgrade, proration, refunds, chargebacks, retries | PAY-001, PLAN-001 | **PARTIAL** | Renewal, cancellation, refunds, chargebacks and queue retries are done and tested. **Upgrade/downgrade mid-term and proration are NOT built** — changing plan today re-prices from the next period, and nothing computes a part-period credit. |
