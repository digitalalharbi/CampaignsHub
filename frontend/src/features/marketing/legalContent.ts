...
const ar: LegalDoc[] = [
  {
    ...
    updated: AR_UPDATED,
    intro: 'توضح هذه السياسة البيانات التي يجمعها كامبينز هَب، وسبب جمعها، ومن يستطيع الاطلاع عليها، وكيف يمكنك حذفها.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'اشتراكك في كامبينز هَب يُحصَّل بالدولار الأمريكي عبر مزوّد دفع. أرقام البطاقات لا تمر بنا ولا تُخزَّن لدينا إطلاقًا — لا رقم بطاقة ولا CVC.',
  ...
  },
  {
    ...
    updated: AR_UPDATED,
    intro: 'تحكم هذه الشروط استخدامك لمنصة كامبينز هَب سواء كنت تدير حملاتك بنفسك أو تطلب خدمة إعلانية.',
    disclaimer: AR_DISCLAIMER,
    sections: [
      {
      ...
      {
        heading: 'اشتراكك في كامبينز هَب',
        bullets: [
      ...
      },
      {
        ...
        body: [
          'هذه فوترة الوكالة لعميلها داخل النظام، وهي منفصلة تمامًا عن اشتراكك في كامبينز هَب. تحتفظ كل فاتورة بعملتها الخاصة — الريال السعودي أو غيره حسب اتفاقك مع عميلك — ولا تتبع عملة الاشتراك. وتُحتسب ضريبة القيمة المضافة حسب المعالجة الضريبية المحددة في العرض أو الفاتورة، وتُعد الفاتورة مستحقة في تاريخ الاستحقاق المذكور فيها.',
        ],
      },
      {
    ...
    sections: [
      {
        heading: 'الأدوار',
        body: [
          'أنت المتحكم في بيانات عملائك وحملاتك. يعمل كامبينز هَب معالجًا لهذه البيانات بالنيابة عنك وبحدود التعليمات التي تصدرها من داخل النظام.',
        ],
      },
      {
  ...
  },
  {
    ...
    title: 'من نحن',
    updated: AR_UPDATED,
    intro: 'كامبينز هَب منصة لإدارة الحملات الإعلانية المدفوعة: تجمع حملاتك وميزانياتك ونتائجك من المنصات المختلفة في مكان واحد.',
    sections: [
      {
        heading: 'لماذا بُنيت',
        body: [
          'يدير المعلن أو الوكالة حملاته على أكثر من منصة، وكل منصة تعرض أرقامها بطريقتها. الوقت يضيع في جمع الأرقام يدويًا بدل تحليلها. كامبينز هَب يوحّد هذه الأرقام، ويقارن الأداء بشكل عادل حسب هدف كل حملة، ويحوّلها إلى تقارير وتنبيهات قابلة للتنفيذ.',
        ],
      },
      {
        heading: 'لمن',
