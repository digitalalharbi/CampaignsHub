...
export const COPY = {
  ar: {
    ...
    st_active: 'نشِط', st_trialing: 'الشهر التمهيدي', st_past_due: 'متأخّر السداد', st_canceled: 'مُلغى',
    features: 'المزايا',
  ...
  en: {
    ...
    st_active: 'Active', st_trialing: 'Introductory month', st_past_due: 'Past due', st_canceled: 'Canceled',
    features: 'Features',
