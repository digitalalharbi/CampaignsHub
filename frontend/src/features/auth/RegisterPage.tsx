...
const JOURNEY_COPY = {
  ar: {
    ...
    editable: 'اختر ما يناسب احتياجك، وسنجهّز لك تجربة كامبينز هَب المناسبة مباشرة.',
...
const REG_COPY = {
  ar: {
    ...
    journeyRequired: 'اختر أولًا كيف ستستخدم كامبينز هَب من الأعلى، لتظهر لك الباقات المناسبة.',
