...
const COPY = {
  ar: {
    ...
    notReported: 'لم ترسل هذه المنصة تفاصيل بطاقات هذا المحتوى — المعروض أعلاه هو الأصل الوحيد المتاح.',
  ...
  en: {
    ...
    next: 'Next card',
    notReported: 'This platform sent no card breakdown for this creative — the asset above is all it exposes.',
